  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      <li class="nav-item active">
        <a style="margin-left: 110px; background:MediumSeaGreen; border:1px solid MediumSeaGreen;" class="btn btn-primary" href="{{route('login')}}">Login<span class="sr-only">(current)</span></a>
      </li>
    </ul>
		...
		<div class="col-sm-6">		
		  	<div  class="card text-center" style="width: 18rem;">
				...
				<div  class="card-body" >
					...
					<a href="{{route('login')}}" class="btn btn-primary">Details</a>
				</div>	   							
			</div>
			<br><br>
		</div>
